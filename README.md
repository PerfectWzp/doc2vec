...
further more, I use these word weights to modify the [wmd](jmlr.org/proceedings/papers/v37/kusnerb15.pdf), impoving performance of document similarity: </br>
WMD is Word Mover's Distance, you can learn it from [From Word Embeddings To Document Distances](jmlr.org/proceedings/papers/v37/kusnerb15.pdf). </br>
